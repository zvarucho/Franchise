            ...
            <div class="main-footer__column">
                ...
                <form action="#" class="login">
                    <div class="login__div">
                        <input type="email" placeholder="Введіть свій email" required class="login__input"></input>
                        <textarea rows="4" name="message" class="login__textarea" placeholder="Твій відгук..." required></textarea>
                    </div>
                    <button type="submit" class="login__button button">Надіслати</button>
                </form>
            </div>
        </div>
    </div>
